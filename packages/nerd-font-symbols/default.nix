...
let
  ...
  src = fetchurl {
    name = fileName;
    url =
      "https://github.com/ryanoasis/nerd-fonts/raw/v${version}/src/glyphs/Symbols-2048-em%20Nerd%20Font%20Complete.ttf";
    sha256 = "sha256-VBaxmBCPvECK5gkySqSu5OFi7zh7xrCOA+lYrySYBss=";
  };
